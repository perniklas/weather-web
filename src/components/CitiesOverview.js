...
import { faCloudSun, faLocationArrow } from '@fortawesome/free-solid-svg-icons';
...
const CitiesOverview = (props) => {
    ...
    return (
        <Col className="w-75">
            ...
            <Row className={"forecast mylocation clickable" + (props.useGPS ? "" : " disabled")} onClick={() => props.selectMyLocation()}>
                <span className="floatleft bold"><FontAwesomeIcon icon={faLocationArrow}></FontAwesomeIcon> My location</span>
            </Row>
            <Row>
